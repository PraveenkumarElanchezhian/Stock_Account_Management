...
public class Deck_of_cards {
	...
	String[] cardNumb = { "201", "302", "403", "504", "605", "706", "807", "908", "1009", "Jack10", "Queen11", "King12",
			"Ace13" };
	String[] cardDeck = new String[52];
	LinkedList<String> queue = new LinkedList<String>();
	int j2 = 0;for(
	int i = 0;i<cardType.length;i++)
	{
	...
	char[] last2 = new char[2];j2=0;
	String temp1, temp2, temp3, temp4;for(
	int p = 0;p<4;p++)
	{
		for (int j = 0; j < 9; j++) {
			arr[j] = cardDeck[j2];
